...
class HomeViewController: UIViewController {
    ...
    var profileButton: UIButton = UIButton(type: UIButton.ButtonType.custom)
    ...
    func configureView() {
        ...
        self.setRightButtons(rightButton: profileButton, rightAction: #selector(profileAction), rightIcon: "personIcon")
    }
    ...
    fileprivate func configSearch(){
        ...
        self.search.searchBar.tintColor = Coulors.white
